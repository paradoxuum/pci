...
public class PessoaFisica extends JFrame {
	...
	JFormattedTextField txtCep = null; //formata o texto
	...
	JComboBox cmbEst = new JComboBox(); //aparecer opções dos estados
	...
	ButtonGroup grupo = new ButtonGroup();{ //group impede marcar mais de uma opção no mesmo objeto
		
		rdbsexo[0] = new JRadioButton("Feminino");
		rdbsexo[1] = new JRadioButton("Masculino");} //fechar chave nou groups
	
	MaskFormatter formatTel = null; //adiciona a máscara
